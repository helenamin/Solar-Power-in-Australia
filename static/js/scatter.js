...
// var svgWidth = document.getElementById("svg-div").offsetWidth;;
var svgWidth = 1050
// var svgHeight = document.getElementById("svg-div").offsetHeight + 600;;
var svgHeight = 550
    ...
    d3.json("/api/v1.0/income").then(function(incomeD) {
      ...
      d3.json("/api/v1.0/rebate").then(function(rebateD) {
        ...
        var mergedData = mergedData.map((item, i) => Object.assign({}, item, outputData[i]));
            ...
            var currentSuburb = currentPostcode
